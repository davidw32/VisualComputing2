...
public class Seesaw extends GraphicsObject {
    ...
    public Seesaw(double initialX, double initialY) {
        ...
        // die Height verändert die Höhe des Dreiecks und damit den maximalen Kippwinkel
        ...
        elementView.fillProperty().addListener(observable -> {
            triangle.setFill(elementView.getFill());
        });
